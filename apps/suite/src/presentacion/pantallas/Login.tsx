...
import { IconoInicio } from '../iconos'

/**
 * Entrada a la suite entera: la misma cuenta que compra y pendientes, porque
 * las tres tiran de un solo proyecto de Supabase. No hay registro; las
 * cuentas se crean a mano, que es todo lo que necesita una casa.
 */
export const Login = () => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Entra aquí y ya estás dentro de la compra y de pendientes.
        </p>
      </div>
