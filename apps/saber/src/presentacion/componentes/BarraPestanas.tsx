...
import { IconoAjustes, IconoCatalogo, IconoInicio } from '../iconos'
...
const PESTANAS: Array<{
  ...
  { id: 'conocimientos', etiqueta: 'Saber', Icono: IconoCatalogo },
  { id: 'ajustes', etiqueta: 'Ajustes', Icono: IconoAjustes },
]

/** Barra inferior de tres pestañas. La activa va en acento sobre tinte. */
