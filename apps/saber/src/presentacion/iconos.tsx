...
/** `link`. El enlace de un conocimiento —por ejemplo, a un vídeo. */
...
/** `camera`. Hacer una foto nueva, en vez de elegir una ya existente. */
...
/** `user`. Quién apuntó un conocimiento. */
export const IconoAutor = (p: Props) => (
  <Svg {...p}>
