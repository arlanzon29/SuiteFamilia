 ...
 *
 * Existe para probar gestos (swipe con física tipo Android) sobre la fila de
 * artículos sin arriesgar la pantalla real. Se llega a ella desde
 * Ajustes → «Pruebas». Cuando el experimento cuaje, lo que sirva se lleva a
 * `DetalleLista.tsx` y este archivo y la ruta `listaPrueba` se borran.
 *
 * El comentario original de la pantalla real, para no perder el porqué de
 * cada decisión mientras se experimenta encima:
 *
 ...
 */
export const DetalleListaPrueba = ({ listaId }: { listaId: string }) => {
