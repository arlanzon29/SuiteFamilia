 ...
 *
 * Uso: `const ripple = useRipple()` en el componente, y en el elemento
 * tocable —que necesita `position: relative` y `overflow: hidden`—
 * `onPointerDown={ripple.onPointerDown}` más `{ripple.nodo}` como hijo (en
 * cualquier punto del JSX, se pinta con `position: absolute`).
 */
